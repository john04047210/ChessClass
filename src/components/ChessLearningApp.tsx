...
export function ChessLearningApp({ locale, messages }: { locale: SupportedLocale; messages: Messages }) {
  ...
  return <div className="app-shell" data-opponent-engine={opponentEngine}>
    ...
    <main className="main-grid"><section className="board-column">
      ...
      <ChessBoard fen={fen} selected={selected} legalTargets={targets} lastMove={lastMove} flipped={flipped} locked={thinking || game.isGameOver()} onSquare={onSquare} onDrop={attemptMove} pieceLabels={messages.pieces} sideLabels={{white:messages.game.white,black:messages.game.black}} boardLabel={messages.game.boardLabel} emptySquareLabel={messages.game.emptySquare} opponentPreview={opponentPreview} />
